...
const hatches: HatchDef[] = [
  ...
  // ─── Arkansas River, CO ──────────────────────────────────────────────────────
  { waterBody: "Arkansas River", region: "Rocky Mountains", state: "CO", month: 1, species: "Chironomidae", insectName: "Midges", insectType: "midge", patternName: "Zebra Midge", timeOfDay: "midday", notes: "Winter midge fishing in the tailwater section below Pueblo Reservoir. Size 20-24." },
  ...
  { waterBody: "Arkansas River", region: "Rocky Mountains", state: "CO", month: 6, species: "Pteronarcys californica", insectName: "Salmonfly", insectType: "stonefly", patternName: "Stimulator", timeOfDay: "all day", notes: "Salmonflies migrate upstream. Size 4-8. Fish large stonefly patterns tight to banks." },
  { waterBody: "Arkansas River", region: "Rocky Mountains", state: "CO", month: 6, species: "Perlidae", insectName: "Golden Stonefly", insectType: "stonefly", patternName: "Prince Nymph", timeOfDay: "all day", notes: "Golden stoneflies overlap with salmonfly hatch. Size 8-10." },
  ...
  { waterBody: "Arkansas River", region: "Rocky Mountains", state: "CO", month: 8, species: "Acrididae", insectName: "Grasshoppers", insectType: "terrestrial", patternName: "Stimulator", timeOfDay: "afternoon", notes: "Bank-side hopper fishing. Terrestrials are key August through September." },
  { waterBody: "Arkansas River", region: "Rocky Mountains", state: "CO", month: 9, species: "Formicidae", insectName: "Flying Ants", insectType: "terrestrial", patternName: "Griffith's Gnat", timeOfDay: "afternoon", notes: "Flying ant falls trigger aggressive surface feeding." },
  ...
  { waterBody: "Frying Pan River", region: "Rocky Mountains", state: "CO", month: 2, species: "Chironomidae", insectName: "Midges", insectType: "midge", patternName: "Griffith's Gnat", timeOfDay: "midday", notes: "Midge clusters on the surface in the catch-and-release section. Ultra-light tippet required." },
  ...
  { waterBody: "Frying Pan River", region: "Rocky Mountains", state: "CO", month: 8, species: "Tricorythodes", insectName: "Trico", insectType: "mayfly", patternName: "Griffith's Gnat", timeOfDay: "morning", notes: "Trico spinnerfalls. Size 22-24. Dawn fishing in slow pools." },
  ...
  { waterBody: "Frying Pan River", region: "Rocky Mountains", state: "CO", month: 10, species: "Baetis", insectName: "Blue-Winged Olive", insectType: "mayfly", patternName: "Pheasant Tail Nymph", timeOfDay: "afternoon", notes: "Late fall BWOs. Nymphing with small PT Nymphs is very productive." },

  // ─── Colorado River, CO ──────────────────────────────────────────────────────
  { waterBody: "Colorado River", region: "Rocky Mountains", state: "CO", month: 2, species: "Chironomidae", insectName: "Midges", insectType: "midge", patternName: "Zebra Midge", timeOfDay: "midday", notes: "Winter midge fishing below Windy Gap Reservoir. Size 20-24." },
  ...
  { waterBody: "Colorado River", region: "Rocky Mountains", state: "CO", month: 6, species: "Pteronarcys californica", insectName: "Salmonfly", insectType: "stonefly", patternName: "Stimulator", timeOfDay: "all day", notes: "Salmonfly hatch in the canyon section. Size 4-8." },
  { waterBody: "Colorado River", region: "Rocky Mountains", state: "CO", month: 6, species: "Perlidae", insectName: "Golden Stonefly", insectType: "stonefly", patternName: "Prince Nymph", timeOfDay: "all day", notes: "Golden stones follow the salmonflies through the canyon." },
  ...
  { waterBody: "Colorado River", region: "Rocky Mountains", state: "CO", month: 7, species: "Hydropsychidae", insectName: "Caddis (various)", insectType: "caddis", patternName: "Elk Hair Caddis", timeOfDay: "evening", notes: "Evening caddis activity increases after runoff. Size 14-16." },
  ...
  { waterBody: "Colorado River", region: "Rocky Mountains", state: "CO", month: 8, species: "Acrididae", insectName: "Grasshoppers", insectType: "terrestrial", patternName: "Stimulator", timeOfDay: "afternoon", notes: "Hopper-dropper rigs along grassy banks." },
  ...
  { waterBody: "Yellowstone River", region: "Rocky Mountains", state: "MT", month: 4, species: "Baetis", insectName: "Blue-Winged Olive", insectType: "mayfly", patternName: "Blue-Winged Olive", timeOfDay: "afternoon", notes: "Early season BWOs before runoff. Size 18-20." },
  { waterBody: "Yellowstone River", region: "Rocky Mountains", state: "MT", month: 6, species: "Pteronarcys californica", insectName: "Salmonfly", insectType: "stonefly", patternName: "Stimulator", timeOfDay: "all day", notes: "World-famous salmonfly hatch. Follows the river upstream through June. Size 2-6." },
  ...
  { waterBody: "Yellowstone River", region: "Rocky Mountains", state: "MT", month: 7, species: "Isoperla", insectName: "Yellow Sally", insectType: "stonefly", patternName: "Prince Nymph", timeOfDay: "afternoon", notes: "Little yellow sallies in the riffles. Size 14-16." },
  { waterBody: "Yellowstone River", region: "Rocky Mountains", state: "MT", month: 8, species: "Acrididae", insectName: "Grasshoppers", insectType: "terrestrial", patternName: "Stimulator", timeOfDay: "afternoon", notes: "Outstanding hopper fishing along grassy banks." },
  ...
  { waterBody: "Yellowstone River", region: "Rocky Mountains", state: "MT", month: 9, species: "Hydropsychidae", insectName: "Caddis (various)", insectType: "caddis", patternName: "Elk Hair Caddis", timeOfDay: "evening", notes: "Late season caddis activity. Size 14-16." },
  ...
  // ─── Big Horn River, MT ──────────────────────────────────────────────────────
  { waterBody: "Big Horn River", region: "Rocky Mountains", state: "MT", month: 1, species: "Chironomidae", insectName: "Midges", insectType: "midge", patternName: "Griffith's Gnat", timeOfDay: "midday", notes: "Winter midge clusters on the surface. Fish dry midge patterns on warm days." },
  ...
  { waterBody: "Big Horn River", region: "Rocky Mountains", state: "MT", month: 3, species: "Baetis", insectName: "Blue-Winged Olive", insectType: "mayfly", patternName: "Pheasant Tail Nymph", timeOfDay: "afternoon", notes: "Early BWOs begin in March. Nymph before they start surfacing." },
  ...
  { waterBody: "Big Horn River", region: "Rocky Mountains", state: "MT", month: 7, species: "Hydropsychidae", insectName: "Caddis (various)", insectType: "caddis", patternName: "Elk Hair Caddis", timeOfDay: "evening", notes: "Summer caddis emergence. Size 14-16." },
  ...
  { waterBody: "Big Horn River", region: "Rocky Mountains", state: "MT", month: 9, species: "Acrididae", insectName: "Grasshoppers", insectType: "terrestrial", patternName: "Stimulator", timeOfDay: "afternoon", notes: "Hopper fishing along brushy banks." },
  ...
  { waterBody: "Henry's Fork", region: "Rocky Mountains", state: "ID", month: 5, species: "Rhithrogena", insectName: "March Brown", insectType: "mayfly", patternName: "Hare's Ear Nymph", timeOfDay: "afternoon", notes: "March Browns in mid-May. Size 12-14. Nymphs very effective." },
  ...
  { waterBody: "Henry's Fork", region: "Rocky Mountains", state: "ID", month: 8, species: "Acrididae", insectName: "Grasshoppers", insectType: "terrestrial", patternName: "Stimulator", timeOfDay: "afternoon", notes: "Hopper fishing along grassy banks. Also flying ants in August." },
  { waterBody: "Henry's Fork", region: "Rocky Mountains", state: "ID", month: 8, species: "Formicidae", insectName: "Flying Ants", insectType: "terrestrial", patternName: "Griffith's Gnat", timeOfDay: "afternoon", notes: "Flying ant falls can produce incredible feeding frenzies. Size 16-18." },
  { waterBody: "Henry's Fork", region: "Rocky Mountains", state: "ID", month: 9, species: "Hydropsychidae", insectName: "Caddis (various)", insectType: "caddis", patternName: "Elk Hair Caddis", timeOfDay: "evening", notes: "Fall caddis activity. Size 14-16." },
  ...
  { waterBody: "Green River", region: "Rocky Mountains", state: "UT", month: 2, species: "Chironomidae", insectName: "Midges", insectType: "midge", patternName: "Griffith's Gnat", timeOfDay: "midday", notes: "Midge clusters on overcast winter days. Size 20-24." },
  { waterBody: "Green River", region: "Rocky Mountains", state: "UT", month: 3, species: "Baetis", insectName: "Blue-Winged Olive", insectType: "mayfly", patternName: "Pheasant Tail Nymph", timeOfDay: "afternoon", notes: "Early BWOs start in March. Size 18-20. Nymph fishing very productive." },
  ...
  { waterBody: "Green River", region: "Rocky Mountains", state: "UT", month: 6, species: "Ephemerella", insectName: "Pale Morning Dun", insectType: "mayfly", patternName: "Parachute Adams", timeOfDay: "morning", notes: "PMDs start in June. Size 16-18." },
  { waterBody: "Green River", region: "Rocky Mountains", state: "UT", month: 7, species: "Ephemerella", insectName: "Pale Morning Dun", insectType: "mayfly", patternName: "Parachute Adams", timeOfDay: "morning", notes: "Peak PMD hatch in July. Size 16-18. Morning emergence." },
  { waterBody: "Green River", region: "Rocky Mountains", state: "UT", month: 8, species: "Tricorythodes", insectName: "Trico", insectType: "mayfly", patternName: "Griffith's Gnat", timeOfDay: "morning", notes: "Trico spinnerfalls. Technical dry fly fishing. Size 22-24." },
  { waterBody: "Green River", region: "Rocky Mountains", state: "UT", month: 8, species: "Acrididae", insectName: "Grasshoppers", insectType: "terrestrial", patternName: "Stimulator", timeOfDay: "afternoon", notes: "Hopper fishing along sage-covered banks." },
  ...
  { waterBody: "Green River", region: "Rocky Mountains", state: "UT", month: 12, species: "Chironomidae", insectName: "Midges", insectType: "midge", patternName: "Zebra Midge", timeOfDay: "midday", notes: "Winter midges. Focus on deep slow runs." },

  // ─── Delaware River, NY/PA ───────────────────────────────────────────────────
  { waterBody: "Delaware River", region: "Northeast", state: "NY", month: 3, species: "Chironomidae", insectName: "Midges", insectType: "midge", patternName: "Zebra Midge", timeOfDay: "midday", notes: "Early season midges. Size 20-24. Fish below the reservoirs." },
  { waterBody: "Delaware River", region: "Northeast", state: "NY", month: 4, species: "Baetis", insectName: "Blue-Winged Olive", insectType: "mayfly", patternName: "Pheasant Tail Nymph", timeOfDay: "afternoon", notes: "BWOs start before the Hendricksons. Size 18-20." },
  { waterBody: "Delaware River", region: "Northeast", state: "NY", month: 4, species: "Ephemerella subvaria", insectName: "Hendrickson", insectType: "mayfly", patternName: "Adams", timeOfDay: "afternoon", notes: "Classic eastern hatch. Size 12-14. Marks the start of dry fly season." },
  ...
  { waterBody: "Delaware River", region: "Northeast", state: "NY", month: 5, species: "Rhithrogena", insectName: "March Brown", insectType: "mayfly", patternName: "Hare's Ear Nymph", timeOfDay: "afternoon", notes: "March Browns on the Delaware. Size 10-12." },
  ...
  { waterBody: "Delaware River", region: "Northeast", state: "NY", month: 6, species: "Hydropsychidae", insectName: "Caddis (various)", insectType: "caddis", patternName: "Elk Hair Caddis", timeOfDay: "evening", notes: "Caddis hatches throughout summer. Size 14-16." },
  ...
  { waterBody: "Delaware River", region: "Northeast", state: "NY", month: 8, species: "Acrididae", insectName: "Grasshoppers", insectType: "terrestrial", patternName: "Stimulator", timeOfDay: "afternoon", notes: "Terrestrial season on the Delaware. Hopper-dropper rigs." },
  ...
  { waterBody: "Ausable River", region: "Northeast", state: "NY", month: 4, species: "Baetis", insectName: "Blue-Winged Olive", insectType: "mayfly", patternName: "Blue-Winged Olive", timeOfDay: "afternoon", notes: "Spring BWOs overlap with Hendricksons. Size 18-20." },
  { waterBody: "Ausable River", region: "Northeast", state: "NY", month: 5, species: "Stenonema vicarium", insectName: "March Brown", insectType: "mayfly", patternName: "Hare's Ear Nymph", timeOfDay: "afternoon", notes: "March Browns in May. Size 10-12." },
  { waterBody: "Ausable River", region: "Northeast", state: "NY", month: 5, species: "Ephemerella dorothea", insectName: "Sulphur", insectType: "mayfly", patternName: "Parachute Adams", timeOfDay: "evening", notes: "Sulphur hatch on the Ausable. Size 14-16." },
  ...
  { waterBody: "Ausable River", region: "Northeast", state: "NY", month: 7, species: "Isoperla", insectName: "Yellow Sally", insectType: "stonefly", patternName: "Prince Nymph", timeOfDay: "afternoon", notes: "Small yellow stoneflies in faster riffles. Size 14-16." },
  ...
  { waterBody: "Battenkill River", region: "Northeast", state: "VT", month: 4, species: "Baetis", insectName: "Blue-Winged Olive", insectType: "mayfly", patternName: "Pheasant Tail Nymph", timeOfDay: "afternoon", notes: "Spring BWOs before Hendricksons peak. Size 18-20." },
  ...
  { waterBody: "Battenkill River", region: "Northeast", state: "VT", month: 5, species: "Rhithrogena", insectName: "March Brown", insectType: "mayfly", patternName: "Hare's Ear Nymph", timeOfDay: "afternoon", notes: "March Browns. Size 10-12." },
  ...
  { waterBody: "Battenkill River", region: "Northeast", state: "VT", month: 6, species: "Isonychia", insectName: "Isonychia (Slate Drake)", insectType: "mayfly", patternName: "Prince Nymph", timeOfDay: "evening", notes: "Slate Drakes in the faster runs. Size 10-12." },
  ...
  { waterBody: "Battenkill River", region: "Northeast", state: "VT", month: 8, species: "Acrididae", insectName: "Grasshoppers", insectType: "terrestrial", patternName: "Stimulator", timeOfDay: "afternoon", notes: "Hopper fishing along pastoral meadow sections." },
  ...
  // ─── Deschutes River, OR ─────────────────────────────────────────────────────
  { waterBody: "Deschutes River", region: "Pacific Northwest", state: "OR", month: 2, species: "Chironomidae", insectName: "Midges", insectType: "midge", patternName: "Zebra Midge", timeOfDay: "midday", notes: "Winter midge fishing in the lower river. Size 18-22." },
  { waterBody: "Deschutes River", region: "Pacific Northwest", state: "OR", month: 3, species: "Rhithrogena", insectName: "March Brown", insectType: "mayfly", patternName: "Hare's Ear Nymph", timeOfDay: "afternoon", notes: "March Browns kick off the season. Size 12-14." },
  { waterBody: "Deschutes River", region: "Pacific Northwest", state: "OR", month: 4, species: "Baetis", insectName: "Blue-Winged Olive", insectType: "mayfly", patternName: "Blue-Winged Olive", timeOfDay: "afternoon", notes: "Spring BWOs. Size 18-20." },
  ...
  { waterBody: "Deschutes River", region: "Pacific Northwest", state: "OR", month: 6, species: "Pteronarcys californica", insectName: "Salmonfly", insectType: "stonefly", patternName: "Stimulator", timeOfDay: "all day", notes: "Salmonfly hatch moves upstream. Size 4-8. Big fish eat big flies." },
  ...
  { waterBody: "Deschutes River", region: "Pacific Northwest", state: "OR", month: 7, species: "Isoperla", insectName: "Yellow Sally", insectType: "stonefly", patternName: "Prince Nymph", timeOfDay: "afternoon", notes: "Little yellow sallies. Size 14-16." },
  { waterBody: "Deschutes River", region: "Pacific Northwest", state: "OR", month: 8, species: "Acrididae", insectName: "Grasshoppers", insectType: "terrestrial", patternName: "Stimulator", timeOfDay: "afternoon", notes: "Hopper fishing along the canyon. Very productive." },
  ...
  // ─── Yakima River, WA ────────────────────────────────────────────────────────
  { waterBody: "Yakima River", region: "Pacific Northwest", state: "WA", month: 2, species: "Chironomidae", insectName: "Midges", insectType: "midge", patternName: "Zebra Midge", timeOfDay: "midday", notes: "Winter midges in slower water. Size 20-22." },
  ...
  { waterBody: "Yakima River", region: "Pacific Northwest", state: "WA", month: 4, species: "Rhithrogena", insectName: "March Brown", insectType: "mayfly", patternName: "Hare's Ear Nymph", timeOfDay: "afternoon", notes: "March Browns in the canyon. Size 12-14." },
  ...
  { waterBody: "Yakima River", region: "Pacific Northwest", state: "WA", month: 6, species: "Pteronarcys californica", insectName: "Salmonfly", insectType: "stonefly", patternName: "Stimulator", timeOfDay: "all day", notes: "Salmonflies in the canyon section." },
  { waterBody: "Yakima River", region: "Pacific Northwest", state: "WA", month: 6, species: "Perlidae", insectName: "Golden Stonefly", insectType: "stonefly", patternName: "Prince Nymph", timeOfDay: "all day", notes: "Golden stones follow salmonflies." },
  ...
  { waterBody: "Yakima River", region: "Pacific Northwest", state: "WA", month: 8, species: "Acrididae", insectName: "Grasshoppers", insectType: "terrestrial", patternName: "Stimulator", timeOfDay: "afternoon", notes: "Prime hopper season." },
  { waterBody: "Yakima River", region: "Pacific Northwest", state: "WA", month: 9, species: "Dicosmoecus", insectName: "October Caddis", insectType: "caddis", patternName: "Elk Hair Caddis", timeOfDay: "evening", notes: "October caddis in the canyon." },
  ...
  // ─── McKenzie River, OR ──────────────────────────────────────────────────────
  { waterBody: "McKenzie River", region: "Pacific Northwest", state: "OR", month: 3, species: "Rhithrogena", insectName: "March Brown", insectType: "mayfly", patternName: "Hare's Ear Nymph", timeOfDay: "afternoon", notes: "March Browns in early spring." },
  { waterBody: "McKenzie River", region: "Pacific Northwest", state: "OR", month: 4, species: "Baetis", insectName: "Blue-Winged Olive", insectType: "mayfly", patternName: "Blue-Winged Olive", timeOfDay: "afternoon", notes: "Spring BWOs on overcast days. Size 18-20." },
  ...
  { waterBody: "McKenzie River", region: "Pacific Northwest", state: "OR", month: 7, species: "Ephemerella", insectName: "Pale Morning Dun", insectType: "mayfly", patternName: "Parachute Adams", timeOfDay: "morning", notes: "PMDs through July. Size 16-18." },
  { waterBody: "McKenzie River", region: "Pacific Northwest", state: "OR", month: 8, species: "Acrididae", insectName: "Grasshoppers", insectType: "terrestrial", patternName: "Stimulator", timeOfDay: "afternoon", notes: "Hopper fishing in late summer." },
  ...
  { waterBody: "White River", region: "Mid-South", state: "AR", month: 2, species: "Lumbriculidae", insectName: "Aquatic Worms", insectType: "other", patternName: "San Juan Worm", timeOfDay: "all day", notes: "San Juan Worms are productive year-round on the White. Red and pink work best." },
  ...
  { waterBody: "White River", region: "Mid-South", state: "AR", month: 4, species: "Baetis", insectName: "Blue-Winged Olive", insectType: "mayfly", patternName: "Blue-Winged Olive", timeOfDay: "afternoon", notes: "Peak spring BWO emergence. Dry fly fishing possible on low-generation days." },
  ...
  { waterBody: "White River", region: "Mid-South", state: "AR", month: 6, species: "Hydropsychidae", insectName: "Caddis (various)", insectType: "caddis", patternName: "Elk Hair Caddis", timeOfDay: "evening", notes: "Caddis activity picks up in June." },
  ...
  { waterBody: "White River", region: "Mid-South", state: "AR", month: 12, species: "Chironomidae", insectName: "Midges", insectType: "midge", patternName: "Zebra Midge", timeOfDay: "midday", notes: "Year-round tailwater fishing. Midges dominate the winter diet." },

  // ─── South Holston River, TN ─────────────────────────────────────────────────
  { waterBody: "South Holston River", region: "Mid-South", state: "TN", month: 1, species: "Chironomidae", insectName: "Midges", insectType: "midge", patternName: "Griffith's Gnat", timeOfDay: "midday", notes: "Winter midge clusters. Size 22-26. Fish during generation breaks." },
  ...
  { waterBody: "South Holston River", region: "Mid-South", state: "TN", month: 3, species: "Baetis", insectName: "Blue-Winged Olive", insectType: "mayfly", patternName: "Pheasant Tail Nymph", timeOfDay: "afternoon", notes: "Spring BWOs. Size 18-20." },
  ...
  { waterBody: "South Holston River", region: "Mid-South", state: "TN", month: 7, species: "Hydropsychidae", insectName: "Caddis (various)", insectType: "caddis", patternName: "Elk Hair Caddis", timeOfDay: "evening", notes: "Summer caddis. Size 14-16." },
  ...
  { waterBody: "South Holston River", region: "Mid-South", state: "TN", month: 11, species: "Chironomidae", insectName: "Midges", insectType: "midge", patternName: "Zebra Midge", timeOfDay: "midday", notes: "Late fall midge fishing. Generation schedule dictates opportunities." },
  ...
  { waterBody: "San Juan River", region: "Mid-South", state: "NM", month: 2, species: "Chironomidae", insectName: "Midges", insectType: "midge", patternName: "Griffith's Gnat", timeOfDay: "midday", notes: "Midge clusters on the surface. Dry-dropper rigs very effective." },
  ...
  { waterBody: "San Juan River", region: "Mid-South", state: "NM", month: 4, species: "Baetis", insectName: "Blue-Winged Olive", insectType: "mayfly", patternName: "Pheasant Tail Nymph", timeOfDay: "afternoon", notes: "Peak spring BWO activity. Nymphs are key." },
  ...
  { waterBody: "San Juan River", region: "Mid-South", state: "NM", month: 6, species: "Hydropsychidae", insectName: "Caddis (various)", insectType: "caddis", patternName: "Elk Hair Caddis", timeOfDay: "evening", notes: "Summer caddis activity below the dam. Size 16-18." },
  ...
  { waterBody: "San Juan River", region: "Mid-South", state: "NM", month: 9, species: "Baetis", insectName: "Blue-Winged Olive", insectType: "mayfly", patternName: "Blue-Winged Olive", timeOfDay: "afternoon", notes: "Fall BWOs begin. Size 20-22." },
  ...
  { waterBody: "San Juan River", region: "Mid-South", state: "NM", month: 12, species: "Chironomidae", insectName: "Midges", insectType: "midge", patternName: "Zebra Midge", timeOfDay: "midday", notes: "Winter midge fishing. Consistent year-round fishery." },

  // ─── Au Sable River, MI ──────────────────────────────────────────────────────
  { waterBody: "Au Sable River", region: "Great Lakes", state: "MI", month: 3, species: "Chironomidae", insectName: "Midges", insectType: "midge", patternName: "Griffith's Gnat", timeOfDay: "midday", notes: "Early season midges. Size 20-22." },
  ...
  { waterBody: "Au Sable River", region: "Great Lakes", state: "MI", month: 4, species: "Baetis", insectName: "Blue-Winged Olive", insectType: "mayfly", patternName: "Pheasant Tail Nymph", timeOfDay: "afternoon", notes: "BWOs overlap with Hendricksons. Size 18-20." },
  ...
  { waterBody: "Au Sable River", region: "Great Lakes", state: "MI", month: 5, species: "Stenonema vicarium", insectName: "March Brown", insectType: "mayfly", patternName: "Hare's Ear Nymph", timeOfDay: "afternoon", notes: "March Browns in May on the Au Sable. Size 10-12." },
  { waterBody: "Au Sable River", region: "Great Lakes", state: "MI", month: 6, species: "Hexagenia limbata", insectName: "Hex Hatch", insectType: "mayfly", patternName: "Adams", timeOfDay: "evening", notes: "The legendary Hex hatch. Size 4-8. Starts at dusk, continues after dark. The biggest dry fly fishing event in the Midwest." },
  { waterBody: "Au Sable River", region: "Great Lakes", state: "MI", month: 6, species: "Isonychia", insectName: "Isonychia (Slate Drake)", insectType: "mayfly", patternName: "Prince Nymph", timeOfDay: "evening", notes: "Slate Drakes in faster sections. Size 10-12." },
  ...
  { waterBody: "Au Sable River", region: "Great Lakes", state: "MI", month: 7, species: "Hydropsychidae", insectName: "Caddis (various)", insectType: "caddis", patternName: "Elk Hair Caddis", timeOfDay: "evening", notes: "Summer caddis. Size 14-16." },
  { waterBody: "Au Sable River", region: "Great Lakes", state: "MI", month: 8, species: "Acrididae", insectName: "Grasshoppers", insectType: "terrestrial", patternName: "Stimulator", timeOfDay: "afternoon", notes: "Hopper and terrestrial fishing through summer." },
  ...
  { waterBody: "Pere Marquette River", region: "Great Lakes", state: "MI", month: 5, species: "Ephemerella dorothea", insectName: "Sulphur", insectType: "mayfly", patternName: "Parachute Adams", timeOfDay: "evening", notes: "Sulphur hatch. Size 14-16." },
  { waterBody: "Pere Marquette River", region: "Great Lakes", state: "MI", month: 6, species: "Hexagenia limbata", insectName: "Hex Hatch", insectType: "mayfly", patternName: "Adams", timeOfDay: "evening", notes: "Hex hatch. Large hex dry patterns after dark. Size 4-8." },
  { waterBody: "Pere Marquette River", region: "Great Lakes", state: "MI", month: 6, species: "Isonychia", insectName: "Isonychia (Slate Drake)", insectType: "mayfly", patternName: "Pheasant Tail Nymph", timeOfDay: "evening", notes: "Slate Drakes emerge through summer. Size 10-12." },
  ...
  { waterBody: "Pere Marquette River", region: "Great Lakes", state: "MI", month: 8, species: "Tricorythodes", insectName: "Trico", insectType: "mayfly", patternName: "Griffith's Gnat", timeOfDay: "morning", notes: "Trico spinnerfalls. Size 22-24." },
  { waterBody: "Pere Marquette River", region: "Great Lakes", state: "MI", month: 9, species: "Acrididae", insectName: "Grasshoppers", insectType: "terrestrial", patternName: "Stimulator", timeOfDay: "afternoon", notes: "Late season terrestrials." },
  ...
  { waterBody: "Florida Keys Flats", region: "Saltwater", state: "FL", month: 2, species: "Alpheus spp.", insectName: "Shrimp (various)", insectType: "other", patternName: "Crazy Charlie", timeOfDay: "morning", notes: "Bonefish on the winter flats. Pink and tan shrimp patterns." },
  ...
  { waterBody: "Florida Keys Flats", region: "Saltwater", state: "FL", month: 6, species: "Megalops atlanticus", insectName: "Tarpon (late season)", insectType: "other", patternName: "Clouser Minnow", timeOfDay: "morning", notes: "Late tarpon. Resident fish remain around the bridges and channels." },
  ...
  { waterBody: "Florida Keys Flats", region: "Saltwater", state: "FL", month: 9, species: "Various baitfish", insectName: "Baitfish (fall migration)", insectType: "other", patternName: "Lefty's Deceiver", timeOfDay: "all day", notes: "Baitfish begin moving. Snook, jacks, and barracuda." },
  ...
  { waterBody: "Florida Keys Flats", region: "Saltwater", state: "FL", month: 11, species: "Alpheus spp.", insectName: "Shrimp (various)", insectType: "other", patternName: "Crazy Charlie", timeOfDay: "morning", notes: "Bonefish return to winter patterns. Sight fishing on shallow flats." },

  // ─── Outer Banks, NC ─────────────────────────────────────────────────────────
  { waterBody: "Outer Banks", region: "Saltwater", state: "NC", month: 3, species: "Sciaenops ocellatus", insectName: "Redfish (spring)", insectType: "other", patternName: "Clouser Minnow", timeOfDay: "morning", notes: "Spring redfish in Pamlico Sound. Copper and gold Clousers." },
  ...
  { waterBody: "Outer Banks", region: "Saltwater", state: "NC", month: 6, species: "Various baitfish", insectName: "Baitfish (summer)", insectType: "other", patternName: "Lefty's Deceiver", timeOfDay: "morning", notes: "Summer cobia and jack crevalle on the flats." },
  ...
  { waterBody: "Outer Banks", region: "Saltwater", state: "NC", month: 10, species: "Euthynnus alletteratus", insectName: "False Albacore (peak)", insectType: "other", patternName: "Clouser Minnow", timeOfDay: "morning", notes: "Peak false albacore fishing. Small white and silver baitfish patterns." },
  ...
  { waterBody: "Louisiana Marsh", region: "Saltwater", state: "LA", month: 2, species: "Sciaenops ocellatus", insectName: "Redfish (late winter)", insectType: "other", patternName: "Lefty's Deceiver", timeOfDay: "midday", notes: "Winter redfish in the interior marsh. Chartreuse and white patterns." },
  ...
  { waterBody: "Louisiana Marsh", region: "Saltwater", state: "LA", month: 4, species: "Alpheus spp.", insectName: "Shrimp (spring)", insectType: "other", patternName: "Crazy Charlie", timeOfDay: "morning", notes: "Spring shrimp runs attract redfish to shallow grass flats." },
  ...
  { waterBody: "Louisiana Marsh", region: "Saltwater", state: "LA", month: 7, species: "Various baitfish", insectName: "Baitfish (summer)", insectType: "other", patternName: "Lefty's Deceiver", timeOfDay: "morning", notes: "Summer jack crevalle in the passes. Explosive topwater action." },
  { waterBody: "Louisiana Marsh", region: "Saltwater", state: "LA", month: 8, species: "Various baitfish", insectName: "Baitfish (late summer)", insectType: "other", patternName: "Lefty's Deceiver", timeOfDay: "morning", notes: "Summer bull redfish and jack crevalle on baitfish patterns." },
  { waterBody: "Louisiana Marsh", region: "Saltwater", state: "LA", month: 9, species: "Sciaenops ocellatus", insectName: "Redfish (early fall)", insectType: "other", patternName: "Clouser Minnow", timeOfDay: "morning", notes: "Fall redfish season begins. Sight fishing on low tides." },
