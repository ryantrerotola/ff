  ...
  return (
    <div className="mb-6">
      <div className="flex flex-col gap-3">
        ...
        <a
          href={providers.github ? "/api/auth/oauth?provider=github" : undefined}
          onClick={
            !providers.github
              ? (e) => {
                  e.preventDefault();
                  alert(
                    "GitHub OAuth is not configured. Set GITHUB_CLIENT_ID and GITHUB_CLIENT_SECRET in your .env file.",
                  );
                }
              : undefined
          }
